...
public class ResizeEffect extends LinkableEffect {
  ...
  private final BlingExecutor executor;
  ...
  public static class ResizeEffectBuilder {
    ...
    private ResizeCallback resizeCallback;
    private BlingExecutor executor;
     ...
     * @param executor an BlingExecutor
     */
    public ResizeEffectBuilder setExecutor(BlingExecutor executor) {
      this.executor = executor;
      return this;
    }
