...
import net.schwehla.matrosdms.rcp.swt.popupshell.helpers.DebugHelper;
import net.schwehla.matrosdms.rcp.swt.popupshell.util.BlingExecutor;
...
public abstract class LinkableEffect implements Runnable {
  ...
  protected BlingExecutor executor;
  ...
  public LinkableEffect(LinkableEffect parent, BlingExecutor executor, int timeInterval, LinkableEffect ... linkableEffects)
