...
package net.schwehla.matrosdms.p2.ui.handlers;
...
public class InstallUnitsHandler {
	...
	URI location = URI.create(
			"http://localhost:8081/nexus/service/local/repositories/master.group.unzip/content/com/vogella/tycho/net.schwehla.matrosdms.update/1.0.0-SNAPSHOT/net.schwehla.matrosdms.update-1.0.0-SNAPSHOT.zip-unzip");
