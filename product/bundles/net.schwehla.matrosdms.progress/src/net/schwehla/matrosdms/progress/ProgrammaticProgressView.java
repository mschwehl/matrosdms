...
public class ProgrammaticProgressView {
	...
	private static final String CLEAR_ALL_ICON_URI = "platform:/plugin/net.schwehla.matrosdms.progress/icons/full/elcl16/progress_remall.png"; //$NON-NLS-1$
...
//		helpSystem.setHelp(parent, IWorkbenchHelpContextIds.RESPONSIVE_UI);
	...
	private void createCommands() {
		...
		clearAllHandler.setContributionURI("bundleclass://net.schwehla.matrosdms.progress/net.schwehla.matrosdms.progress.ClearAllHandler"); //$NON-NLS-1$
		...
		showPreferencesHandler.setContributionURI("bundleclass://net.schwehla.matrosdms.progress/net.schwehla.matrosdms.progress.OpenPreferenceDialogHandler"); //$NON-NLS-1$
