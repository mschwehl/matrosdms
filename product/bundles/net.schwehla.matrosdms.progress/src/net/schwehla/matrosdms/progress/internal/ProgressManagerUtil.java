...
import net.schwehla.matrosdms.progress.internal.legacy.StatusUtil;
...
public class ProgressManagerUtil {
	...
	public static void openProgressView() {
		...
		MWindow current = services.getMWindow();
		
		// Dialogs dont have active Windows
		// XXX maybe find in first occurecce
		if (current == null) {
			return;
		}
