...
import net.schwehla.matrosdms.progress.UIJob;
import net.schwehla.matrosdms.progress.internal.legacy.EventLoopProgressMonitor;
import net.schwehla.matrosdms.progress.internal.legacy.PlatformUI;
import net.schwehla.matrosdms.progress.internal.legacy.Policy;
...
public class ProgressManager extends ProgressProvider {
	...
	static final String PROGRESS_VIEW_NAME = "net.schwehla.matrosdms.progress.ProgressView"; //$NON-NLS-1$
